...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__data_json__ = __webpack_require__(1);
...
__WEBPACK_IMPORTED_MODULE_1_jquery___default()(function() {
	...
	__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.grade').click(function(){
		var state = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.grade').children('ul').css("display");
		__WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).addClass("color").siblings().removeClass("color");
		//$('.list-classes').css('display','none');
		__WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).find('.dis').slideToggle('middle');
		__WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).siblings().find('.dis').slideUp('middle');
		
		__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.list-grade li img').css("transform","rotate(0deg)");
